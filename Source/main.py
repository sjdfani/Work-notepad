...
class Table(QMainWindow):
    ...
    def function_connection(self):
        ...
        self.ui.year_lineEdit_show.textChanged.connect(self.textChanged_year_show)
        self.ui.month_lineEdit_show.textChanged.connect(self.textChanged_month_show)
        self.ui.day_lineEdit_show.textChanged.connect(self.textChanged_day_show)
        self.ui.submit_btn_show.clicked.connect(self.submit_btn_show)
        self.ui.choose_photo_btn_show.clicked.connect(self.browse_fileAddress_photo_show)
        self.ui.clear_btn_uni_add.clicked.connect(self.clearAddUniversity)
        self.ui.icon_done_btn_uni_add.clicked.connect(self.doneBtnAddUniversity)
        self.ui.icon_heart_btn_uni_add.clicked.connect(self.heartBtnAddUniversity)
        self.ui.icon_circle_btn_uni_add.clicked.connect(self.circleBtnAddUniversity)
        self.ui.icon_circleStar_btn_uni_add.clicked.connect(self.starCircleBtnAddUniversity)
        self.ui.icon_starOut_btn_uni_add.clicked.connect(self.starOutBtnAddUniversity)
        self.ui.icon_sadEmoji_btn_uni_add.clicked.connect(self.sadBtnAddUniversity)
        self.ui.icon_smileEmoji_btn_uni_add.clicked.connect(self.smileBtnAddUniversity)
        self.ui.icon_starFill_btn_uni_add.clicked.connect(self.starFillBtnAddUniversity)
        self.ui.submit_btn_uni_add.clicked.connect(self.submitUniversityAddEvent)
        ...
        self.ui.back_btn_uni_add.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.University))
        self.ui.back_btn_uni_info.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.University))
        ...
        self.ui.icon_smileEmoji_btn.clicked.connect(self.smileBtnInfoUniversity)
        self.ui.icon_sadEmoji_btn.clicked.connect(self.sadBtnInfoUniversity)
        self.ui.icon_starFill_btn.clicked.connect(self.starFillBtnInfoUniversity)
        self.ui.icon_starOut_btn.clicked.connect(self.starOutBtnInfoUniversity)
        self.ui.icon_circleStar_btn.clicked.connect(self.starCircleBtnInfoUniversity)
        ...
        self.ui.icon_smileEmoji_btn_table_add.clicked.connect(self.smileBtnAddTable)
        self.ui.icon_sadEmoji_btn_table_add.clicked.connect(self.sadBtnAddTable)
        self.ui.icon_circle_btn_table_add.clicked.connect(self.circleBtnAddTable)
        self.ui.icon_circleStar_btn_table_add.clicked.connect(self.starCircleBtnAddTable)
        self.ui.icon_starFill_btn_table_add.clicked.connect(self.starFillBtnAddTable)
        self.ui.icon_starOut_btn_table_add.clicked.connect(self.starOutBtnAddTable)
        ...
        self.ui.icon_smileEmoji_table_info.clicked.connect(self.smileBtnInfoTable)
        ...
        self.ui.icon_circleStar_table_info.clicked.connect(self.starCircleBtnInfoTable)
        self.ui.icon_starOut_table_info.clicked.connect(self.starOutBtnInfoTable)
        self.ui.icon_starFill_table_info.clicked.connect(self.starFillBtnInfoTable)
        self.ui.edit_btn_table_info.clicked.connect(self.editEventTable)
        self.ui.submit_btn_table_info.clicked.connect(self.submitEditEventTable)
        self.ui.clear_btn_table_info.clicked.connect(self.clearInfoTable)
        self.ui.back_btn_table_add.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Table))
        self.ui.back_btn_table_info.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Table))
    ...
    def menu_func(self):
        if self.handle_menu == "close":
            ...
            icon = QIcon()
            icon.addPixmap(QPixmap("photo/outline_menu_open_black_24dp.png"), QIcon.Normal, QIcon.Off)
            ...
            icon = QIcon()
            icon.addPixmap(QPixmap("photo/outline_menu_black_24dp.png"), QIcon.Normal, QIcon.Off)
            self.ui.menu_btn.setIcon(icon)
    ...
    def setTooltipDays(self, frame, inputDays):
        ...
        if inputDays < 0:
            if frame == "1":
                self.ui.day_frameH_1.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "2":
                self.ui.day_frameH_2.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "3":
                self.ui.day_frameH_3.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "4":
                self.ui.day_frameH_4.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "5":
                self.ui.day_frameH_5.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "6":
                self.ui.day_frameH_6.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "7":
                self.ui.day_frameH_7.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "8":
                self.ui.day_frameH_8.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "9":
                self.ui.day_frameH_9.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "10":
                self.ui.day_frameH_10.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "11":
                self.ui.day_frameH_11.setToolTip(_translate("MainWindow", "Remaining days"))
            elif frame == "12":
                self.ui.day_frameH_12.setToolTip(_translate("MainWindow", "Remaining days"))
        elif inputDays > 0:
            if frame == "1":
                self.ui.day_frameH_1.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "2":
                self.ui.day_frameH_2.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "3":
                self.ui.day_frameH_3.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "4":
                self.ui.day_frameH_4.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "5":
                self.ui.day_frameH_5.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "6":
                self.ui.day_frameH_6.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "7":
                self.ui.day_frameH_7.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "8":
                self.ui.day_frameH_8.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "9":
                self.ui.day_frameH_9.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "10":
                self.ui.day_frameH_10.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "11":
                self.ui.day_frameH_11.setToolTip(_translate("MainWindow", "Pass days"))
            elif frame == "12":
                self.ui.day_frameH_12.setToolTip(_translate("MainWindow", "Pass days"))
        else:
            if frame == "1":
                self.ui.day_frameH_1.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "2":
                self.ui.day_frameH_2.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "3":
                self.ui.day_frameH_3.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "4":
                self.ui.day_frameH_4.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "5":
                self.ui.day_frameH_5.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "6":
                self.ui.day_frameH_6.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "7":
                self.ui.day_frameH_7.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "8":
                self.ui.day_frameH_8.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "9":
                self.ui.day_frameH_9.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "10":
                self.ui.day_frameH_10.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "11":
                self.ui.day_frameH_11.setToolTip(_translate("MainWindow", "Today"))
            elif frame == "12":
                self.ui.day_frameH_12.setToolTip(_translate("MainWindow", "Today"))
    ...
    def addEvent_func(self):
        ...
        self.ui.back_btn_add.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Home))
        ...
        self.ui.choose_photo_btn_add.clicked.connect(self.browse_fileAddress_photo_add)
                            ...
                            if int(dateCurr[1]) <= int(self.ui.month_lineEdit.text()) <= 12:
                                if int(self.ui.month_lineEdit.text()) in self.day_31:
                                    if int(dateCurr[2]) <= int(self.ui.day_lineEdit.text()) <= 31:
                                        ...
                                        self.showError("Day", f"Day should be between {dateCurr[2]}-{31}")
                                    ...
                                    if int(dateCurr[2]) <= int(self.ui.day_lineEdit.text()) <= 30:
                                        ...
                                        self.showError("Day", f"Day should be between {dateCurr[2]}-{30}")
                                    ...
                                    if int(dateCurr[2]) <= int(self.ui.day_lineEdit.text()) <= 28:
                                        ...
                                        self.showError("Day", f"Day should be between {dateCurr[2]}-{28}")
                            else:
                                self.showError("Month", f"Month should be between {dateCurr[1]}-{12}")
                        else:
                            self.showError("Year", f"Year should be between {dateCurr[0]}-{int(dateCurr[0]) + 50}")
                    else:
    ...
    def browse_fileAddress_photo_add(self):
        try:
            ...
            self.ui.photo_label_add.setPixmap(QPixmap(self.fileAddressPhoto_add))
        except:
            print("")
    ...
    def setting_func(self):
        ...
        self.ui.back_btn_setting.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Home))
    ...
    def table_func(self):
        ...
        self.ui.back_btn_table.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Home))
    ...
    def university_func(self):
        ...
        self.ui.back_btn_uni.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Home))
    ...
    def email_func(self):
        ...
        self.ui.titleEmail_lineEdit.textChanged.connect(self.textChange_title_Email)
        self.ui.NameEmail_lineEdit.textChanged.connect(self.textChange_name_Email)
        self.ui.massageEmail_textEdit.textChanged.connect(self.textChange_massage_Email)
    ...
    def send_email_process(self, num):
        from_email = "faniam598@gmail.com"
        password = "Raven20120"
    ...
    def connection_process(self, num):
        ...
        try:
            ...
            self.ui.connection_btn.setToolTip(_translate("MainWindow", "Connect"))
            icon = QIcon()
            ...
            self.ui.connection_btn.setToolTip(_translate("MainWindow", "Disconnect"))
            icon = QIcon()
    ...
    def history_func(self):
        ...
        self.ui.id_lineEdit_history.textChanged.connect(self.textChange_id_history)
    ...
    def history_delete(self):
        btn = QMessageBox.question(self, "Delete", "Are you sure?", QMessageBox.Yes | QMessageBox.No)
        if btn == QMessageBox.Yes:
            ...
            if len(row) != 0:
                ...
                self.showError("Delete", f"{self.ui.id_lineEdit_history.text()} is not exist.")
    ...
    def history_search(self):
        ...
        if len(row) != 0:
            ...
            self.ui.tableWidget_history.setItem(0, 0, QTableWidgetItem(str(row[0][0])))
            self.ui.tableWidget_history.setItem(0, 1, QTableWidgetItem(row[0][1]))
            self.ui.tableWidget_history.setItem(0, 2, QTableWidgetItem(row[0][2]))
            self.ui.tableWidget_history.setItem(0, 3, QTableWidgetItem(row[0][3]))
            self.ui.tableWidget_history.setItem(0, 4, QTableWidgetItem(str(delta_days) + " Days ago"))
            self.ui.tableWidget_history.setItem(0, 5, QTableWidgetItem(row[0][4]))
        else:
            self.showError("Search", f"{self.ui.id_lineEdit_history.text()} is not exist.")
    ...
    def delta_date(inputDate):
        if len(inputDate) != 0:
            ...
            delta = date(int(currYear), int(currMonth), int(currDay)) - date(int(year), int(month), int(day))
            return delta.days
    ...
    def history_TableProcess(self):
        ...
        for item in rows:
            ...
            self.ui.tableWidget_history.setItem(row, 0, QTableWidgetItem(str(item[0])))
            self.ui.tableWidget_history.setItem(row, 1, QTableWidgetItem(item[1]))
            self.ui.tableWidget_history.setItem(row, 2, QTableWidgetItem(item[2]))
            self.ui.tableWidget_history.setItem(row, 3, QTableWidgetItem(item[3]))
            self.ui.tableWidget_history.setItem(row, 4, QTableWidgetItem(str(delta_days) + " Days ago"))
            self.ui.tableWidget_history.setItem(row, 5, QTableWidgetItem(item[4]))
            row += 1
    ...
    def submit_btn_show(self):
        if self.year_show and self.month_show and self.day_show:
            ...
            self.showError("Error", "Please check your year,month,day lineEdit.")
    ...
    def browse_fileAddress_photo_show(self):
        try:
            ...
            self.ui.photo_label_show.setPixmap(QPixmap(self.fileAddressPhoto_show))
        except:
            print("")
    ...
    def delete_btn_home(self):
        btn = QMessageBox.question(self, "Delete", "Are you sure?", QMessageBox.Ok | QMessageBox.Cancel)
    ...
    def setIconInfoTables(self, frame, inputIcon, inputType):
        if frame == "1":
            if inputIcon == "done":
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_done_black_24dp.png"), QIcon.Normal, QIcon.Off)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_favorite_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_star_outline_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_star_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_circle_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_stars_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_sentiment_satisfied_alt_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
                ...
                icon = QIcon()
                icon.addPixmap(QPixmap("photo/outline_sentiment_dissatisfied_black_24dp.png"), QIcon.Normal, QIcon.Off)
                if inputType == "University":
                    self.ui.uni_btn_1.setIcon(icon)
                elif inputType == "Table":
                    self.ui.table_btn_1.setIcon(icon)
    ...
    def askForBuildEvent(self):
        info = QMessageBox.question(self, "Add Event", "Do you want to open event ?", QMessageBox.Yes | QMessageBox.No)
    ...
    def deleteProcessUniversity(frame):
        data = UniversityBackend.search_frame(frame)
        HistoryBackend.insert(f"class: {data[0][1]}", data[0][2], "", "deleted")
        UniversityBackend.delete(frame)

    def deleteEventUniversity(self):
        ques = QMessageBox.question(self, "Delete", "Are you sure ?", QMessageBox.Yes | QMessageBox.No)
    ...
    def deleteProcessTable(frame):
        data = TableBackend.search_frame(frame)
        HistoryBackend.insert(f"Table: {data[0][1]}", data[0][2], "", "deleted")
    ...
    def lockBtnHome(self):
        ...
        if self.stateLockBtn == "Disable":
            ...
            icon = QIcon()
            icon.addPixmap(QPixmap("photo/outline_lock_black_24dp.png"), QIcon.Normal, QIcon.Off)
            ...
            icon = QIcon()
            icon.addPixmap(QPixmap("photo/outline_lock_open_black_24dp.png"), QIcon.Normal, QIcon.Off)
            self.ui.lock_btn.setIcon(icon)
